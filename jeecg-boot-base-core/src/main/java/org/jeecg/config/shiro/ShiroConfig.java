...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
        ...
        // 配置不会被拦截的链接 顺序判断
//        filterChainDefinitionMap.put("/collection/**", "anon"); //测试接口
//        微信请求接口
        filterChainDefinitionMap.put("/test/magic-tool/wxRequest", "anon"); //授权接口排除
        filterChainDefinitionMap.put("/sys/wxLogin", "anon"); //微信登录接口排除
