  ...
  PDFPageView.prototype = {
    ...
    cssTransform: function PDFPageView_transform(canvas, redrawAnnotations) {
      ...
      if (this.textLayer) {
        ...
        // TODO-Jeecg Source: This could probably be simplified by drawing the text layer in
...
var PDFViewerApplication = {
  ...
  initialize: function pdfViewInitialize() {
    ...
    var initializedPromise = Promise.all([
      ...
      // TODO-Jeecg Source move more preferences and other async stuff here
  ...
  // TODO-Jeecg Source(mack): This function signature should really be pdfViewOpen(url, args)
  ...
  beforePrint: function pdfViewSetupBeforePrint() {
    ...
    // TODO-Jeecg Source(robwu): Use named pages when size calculation bugs get resolved
